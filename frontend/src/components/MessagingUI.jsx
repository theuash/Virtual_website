      ...
      <div className="wa-sidebar">
        <div className="wa-sidebar-header">
          <div className="flex items-center gap-3">
            ...
            <span className="md:hidden font-bold text-lg">WhatsApp</span>
          </div>
          ...
          <>
            <div className="wa-chat-header">
              <div className="wa-chat-header-info" onClick={() => setIsMobileChatOpen(false)}>
                ...
                <div className="wa-avatar" style={{ width: '40px', height: '40px', marginRight: '10px' }}>
                ...
                <div>
                  <div className="wa-chat-name" style={{ fontSize: '16px' }}>{selectedConv.name}</div>
            ...
            <form className="wa-chat-input-area" onSubmit={handleSendMessage}>
              ...
              <button type="submit" className="bg-transparent border-none p-2 cursor-pointer">
                <Send size={24} className={`${newMessage.trim() ? 'text-[#00a884]' : 'text-gray-500'}`} />
              </button>
            </form>
          </>
        ) : (
