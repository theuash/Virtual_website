...
export default function FreelancerMeet() {
  ...
  const handleScheduleMeeting = async (e) => {
    e.preventDefault();
    try {
      const res = await api.post('/freelancer/meetings', formData);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
              Schedule and conduct video meetings with clients
            </p>
          </div>
          <button
        ...
        {meetings.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm mb-6 max-w-sm mx-auto" style={{ color: 'var(--text-secondary)' }}>
              Schedule your first meeting with a client to get started with video conferencing.
            </p>
            <button
              onClick={() => setShowSchedule(true)}
