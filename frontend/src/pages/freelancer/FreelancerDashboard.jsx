...
const TIER_DESCRIPTIONS = {
  precrate:            'Entry level — complete projects to advance.',
...
const LEARNING_MODULES = [
  {
    ...
    desc: 'How Virtual works — departments, micro-tasks, and the chain of command.',
    duration: '8 min',
    locked: false,
    completed: true,
  },
  {
    ...
    desc: 'Standards expected at every tier. What Momentum Supervisors check before approval.',
    duration: '12 min',
    locked: false,
    completed: false,
  },
  {
    ...
    desc: 'How client funds move from wallet to escrow to your earnings.',
    duration: '6 min',
    locked: false,
    completed: false,
  },
  {
    id: 4,
    title: 'Advancing Through Tiers',
    desc: 'The three metrics that drive promotion: accuracy, speed, and volume.',
    duration: '10 min',
    locked: true,
    completed: false,
  },
            ...
            <div className="mt-4">
              ...
              <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'var(--border)' }}>
                <div
                  ...
                  style={{ width: `${taskPct}%`, background: 'var(--accent)' }}
                />
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-4 space-y-2">
              {projects.length === 0 ? (
                ...
                <div
                  key={task._id || i}
                  className="group flex items-center justify-between p-4 rounded-lg border transition-all cursor-pointer hover:border-accent"
                  style={{ background: 'var(--bg-card)', borderColor: 'var(--border)' }}
                  onClick={() => navigate('/freelancer/tasks')}
                >
                  <div className="flex-1 min-w-0 pr-4">
                    <div className="text-sm font-semibold truncate mb-1" style={{ color: 'var(--text-primary)' }}>
                      {task.title}
                    </div>
                    <div className="flex items-center gap-3 text-[11px]" style={{ color: 'var(--text-secondary)' }}>
                      <span className="flex items-center gap-1">
                        <Clock size={10} /> {task.estimation || '2–3 hrs'}
                      </span>
                      <span
              ...
              <div className="p-3 space-y-2">
                {LEARNING_MODULES.map(module => (
                  <div
                    ...
                    style={{
                      background: module.completed ? 'var(--bg-card)' : 'var(--bg-card)',
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: module.completed ? 'var(--accent)' : 'var(--border)',
                        color: module.completed ? '#fff' : 'var(--text-secondary)',
                      }}
                    >
                      {module.locked ? (
